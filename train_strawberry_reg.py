...
def parse_args():
    ...
    parser.add_argument('--model', default='pointnet_regression', help='model name [default: pointnet_cls]')
...
def main(args):
    ...
    shutil.copy('./train_strawberry_reg.py', str(exp_dir))
    shutil.copy('data_utils/StrawberryDataLoader.py', str(exp_dir))
